...
\definechangesauthor[color=blue]{v2}

\begin{document}

\noindent {\LARGE {\bf Version v2}}\\

Version v2 adds Chapters 4, 6, and 7, making it a complete draft. Changes to other chapters are marked in blue text with a v2 superscript. The following table lists changes to previously released drafts with links.
